        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-4">
                        <img class="img-fluid bg-light rounded p-1" src="{{asset('frontend')}}/img/product-1.jpg"
                            alt="Image">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light rounded p-1" src="{{asset('frontend')}}/img/product-2.jpg"
                            alt="Image">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light rounded p-1" src="{{asset('frontend')}}/img/product-3.jpg"
                            alt="Image">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light rounded p-1" src="{{asset('frontend')}}/img/product-2.jpg"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                &copy; <a href="#">BakerzBite.Com</a>, All Right Reserved.
            </div>
